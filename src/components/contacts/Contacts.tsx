            ...
            <div className={s.contactsBlock} id={props.id}>
                <div className={`${styleContainer.container} ${s.contactsContainer}`}>
                    ...
                    <form className={s.form} onSubmit={sendEmail}>
                        ...
                        <input placeholder={"Your phone number"} className={s.input} type={"text"} name={"phone-number"}/>
                        <input required placeholder={"Your email"} className={s.input} type={"text"} name={"user-email"}/>
                        <textarea required placeholder={"Your message"} className={s.textarea} name={"message"}></textarea>
